...
var MyComponent = /** @class */ (function () {
    ...
    MyComponent.prototype.render = function () {
        return (h("div", { class: "header" }, h("a", { class: "header__logo", href: "http://google.com" }, "LOGO"), h("nav", { class: "header__linkList" }, h("ul", null, links.map(function (link) { return (h("li", null, h("a", { href: link.url }, link.name))); })))));
    };
    return MyComponent;
}());
